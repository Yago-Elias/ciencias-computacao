...
enum {WRONG_WORD, CORRECT_WORD, REPEATED_LETTER, NOT_LETTER, IS_STRING, UNREPEATED_LETTER, 
LETTER_FOUND, LETTER_NOT_FOUND, ERROR_OPEN_FILE, WORD_LENGTH=14, SCREEN_SIZE=40};
